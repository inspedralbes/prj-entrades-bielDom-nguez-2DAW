...
/**
 * Confirmació de comandes cinema (seat_layout JSON + claus Redis).
 */
class CinemaSeatOrderConfirmation
{
    ...
    /**
     * A. Bloqueja comanda i esdeveniment; valida seat_key i conflictes al layout.
     * B. Marca seients venuts al layout, crea entrades JWT, comanda pagada.
     * C. Notifica Redis/socket com a venuts.
     *
