...
return [
    ...
    */
    ...
    'query_cache' => [
         ...
         * Per defecte desactivat (local/Docker): la serialització AST a la cache pot trencar-se
         * (__PHP_Incomplete_Class) després de canvis de dependències i provoca «Internal server error» al GraphQL.
         * A producció es pot activar amb LIGHTHOUSE_QUERY_CACHE_ENABLE=true.
         */
