...
- **Temps real**: Els fluxos Socket.IO són coherents amb estat ja validat o explícitament coordinat amb l’API; no substitueixen confirmacions crítiques on calgui.
